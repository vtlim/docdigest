...
def has_existing_summary_component(content: str, variable_name: str) -> bool:
    ...
    details_pattern = rf'<details[^>]*>.*?<summary>Summary</summary>.*?{{{variable_name}}}.*?Generated by AI.*?</details>'
...
def remove_existing_summary_components(content: str) -> str:
    ...
    details_pattern = r'<details[^>]*>.*?<summary>Summary</summary>.*?Generated by AI.*?</details>\s*\n*'
